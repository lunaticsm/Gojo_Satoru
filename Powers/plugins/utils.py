...
async def reporting_query(c: Gojo, m: Message):
    ...
    kb = InlineKeyboardMarkup([[InlineKeyboardButton("Update channel",url=f"https://t.me/{SUPPORT_GROUP}")],[InlineKeyboardButton("Report on pm",url="https://t.me/hentaiiboys")]])
    try:
